...
title @s[scores={temperature_int=41.., temperature_float=0..9, temperature_changed=1}] actionbar ["",{"score":{"name":"@s","objective":"temperature_int"},"color":"#FF6B00"},{"text":".","color":"#FF6B00"},{"score":{"name":"@s","objective":"temperature_float"},"color":"#FF6B00"},{"text":"°C","color":"#FF6B00"}]
