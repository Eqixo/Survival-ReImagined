...
# ]-∞;37[ °C
execute store result entity @s[scores={temperature_int=..37}] attributes[{id:"minecraft:generic.attack_speed"}].base double 0.1062 run scoreboard players get @s temperature_int
...
execute store result entity @s[scores={temperature_int=38..}] attributes[{id:"minecraft:generic.attack_speed"}].base double 0.01 run scoreboard players get @s debuff