...
execute store result entity @s attributes[{id:"minecraft:max_health"}].base float 4 run data get entity @s Health
...
execute store result entity @s attributes[{id:"minecraft:attack_damage"}].base double 4 run attribute @s attack_damage base get

# Store the base value of the "follow_range" attribute in the variable "FollowRange"
execute store result entity @s attributes[{id:"minecraft:follow_range"}].base double 3 run attribute @s follow_range base get
