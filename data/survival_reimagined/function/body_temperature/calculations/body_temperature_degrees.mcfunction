...
title @s[scores={bodyTemperatureInt=37..40, hasBodyTemperatureChanged=1}] actionbar ["",{"score":{"name":"@s","objective":"bodyTemperatureInt"},"color":"#FFFF55"},{"text":".","color":"#FFFF55"},{"score":{"name":"@s","objective":"bodyTemperatureFloat"},"color":"#FFFF55"},{"text":"°C","color":"#FFFF55"}]
...
title @s[scores={bodyTemperatureInt=37..40, bodyTemperatureFloat=0..9, hasBodyTemperatureChanged=1}] actionbar ["",{"score":{"name":"@s","objective":"bodyTemperatureInt"},"color":"#FFFF55"},{"text":".0","color":"#FFFF55"},{"score":{"name":"@s","objective":"bodyTemperatureFloat"},"color":"#FFFF55"},{"text":"°C","color":"#FFFF55"}]
