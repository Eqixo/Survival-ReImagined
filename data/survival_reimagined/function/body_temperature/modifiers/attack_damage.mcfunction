...
execute store result entity @s[scores={temperature_int=..37}] attributes[{id:"minecraft:attack_damage"}].base double 0.33 run scoreboard players get @s debuff
...
execute store result entity @s[scores={temperature_int=38..}] attributes[{id:"minecraft:attack_damage"}].base double 0.5 run scoreboard players get @s debuff