...
execute store result entity @s[scores={temperature_int=38..}] attributes[{id:"minecraft:generic.attack_damage"}].base double 0.5 run scoreboard players get @s debuff