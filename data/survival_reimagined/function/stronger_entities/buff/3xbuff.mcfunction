...
execute store result entity @s attributes[{id:"minecraft:generic.attack_damage"}].base double 3 run attribute @s attack_damage base get

# Store the base value of the "follow_range" attribute in the variable "FollowRange"
execute store result entity @s attributes[{id:"minecraft:generic.follow_range"}].base double 2 run attribute @s follow_range base get
