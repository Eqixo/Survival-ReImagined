...
# This advancement is achieved when the player's temperature is above overheating.
advancement grant @s[scores={temperature_int=38..}] only minecraft:survival_reimagined/i_am_hot
